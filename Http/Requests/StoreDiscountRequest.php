...
class StoreDiscountRequest extends FormRequest
{
    ...
    public function rules(Request $request)
    {
        if($this->method() == 'POST'){
            ...
            $rules = [
                'code' => 'required|unique:villamanager__discounts,code,'.$request->route('discount')->id,
                'type' => 'required',
                'discount' => 'required|integer',
                'total' => 'required',
                'start_date' => 'required',
    ...
    public function all()
    {
        $input = parent::all(); // TODO: Change the autogenerated stub
        $input['villa_id'] = json_encode($input['villa_id']);
        return $input;
    }
