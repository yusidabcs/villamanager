...
class FacilityController extends AdminBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        flash()->success(trans('core::core.messages.resource created', ['name' => trans('villamanager::facilities.title.facilities')]));
    ...
    public function update(Facility $facility, Request $request)
    {
        ...
        flash()->success(trans('core::core.messages.resource updated', ['name' => trans('villamanager::facilities.title.facilities')]));
    ...
    public function destroy(Facility $facility)
    {
        ...
        flash()->success(trans('core::core.messages.resource deleted', ['name' => trans('villamanager::facilities.title.facilities')]));
