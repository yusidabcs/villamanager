...
class DisableDateController extends AdminBaseController {
	...
	public function store(Request $request)
	{
        ...
        return redirect()->back()
            ->withSuccess(trans('core::core.messages.resource created', ['name' => trans('villamanager::disabledates.title.disabledates')]));
	}
    ...
    public function destroy(DisableDate $disableDate,Request $request)
    {
        ...
        return redirect()->route('admin.villamanager.rate.index')
            ->withSuccess(trans('core::core.messages.resource deleted', ['name' => trans('villamanager::disabledates.title.disabledates')]));
    }
}