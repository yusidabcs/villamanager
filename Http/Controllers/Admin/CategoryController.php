...
class CategoryController extends BaseVillaModuleController
{
    ...
    public function store(StoreCategoryRequest $request)
    {
        ...
        flash()->success(trans('core::core.messages.resource created', ['name' => trans('villamanager::categories.title.categories')]));
    ...
    public function update(Request $request,VillaCategory $villa_category)
    {
        ...
        flash()->success(trans('core::core.messages.resource updated', ['name' => trans('villamanager::categories.title.categories')]));
    ...
    public function destroy(VillaCategory $villa_category)
    {
        ...
        flash()->success(trans('core::core.messages.resource deleted', ['name' => trans('villamanager::categories.title.categories')]));
