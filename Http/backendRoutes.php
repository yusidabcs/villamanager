...
$router->group(['prefix' =>'/villamanager'], function (Router $router) {
    ...
    $router->get('villas/{villa}/copy', [
        'as' => 'admin.villamanager.villa.copy',
        'uses' => 'VillaController@copy',
        'middleware' => 'can:villamanager.villas.copy'
    ]);
    ...
    $router->post('images/delete-all', [
        'as' => 'admin.villamanager.image.delete-all',
...
// append
    ...
    $router->get('bookings/reports',[
        'as' => 'admin.villamanager.booking.report',
        'uses' => 'BookingController@bookingReport'
    ]);
    $router->post('bookings', [
        'as' => 'admin.villamanager.booking.store',
        'uses' => 'BookingController@store',
        'middleware' => 'can:villamanager.bookings.create'
    ]);
    ...
    $router->get('bookings/{id}/export-ics', [
        'as' => 'admin.villamanager.booking.export-ics',
    ...
    $router->post('inquiries', [
        ...
        'uses' => 'BookingController@store',
        'middleware' => 'can:villamanager.inquiries.create'
    ]);
    ...
    $router->post('disabledates', [
        ...
        'middleware' => 'can:villamanager.disabledates.create'
    ]);
    ...
    $router->get('categories', [
        'as' => 'admin.villamanager.category.index',
        'uses' => 'CategoryController@index',
        'middleware' => 'can:villamanager.categories.index'
    ]);

    $router->post('categories', [
        'as' => 'admin.villamanager.category.store',
        'uses' => 'CategoryController@store',
        'middleware' => 'can:villamanager.categories.create'
    ]);

    $router->get('categories/create', [
        'as' => 'admin.villamanager.category.create',
        'uses' => 'CategoryController@create',
        'middleware' => 'can:villamanager.categories.create'
    ]);

    $router->get('categories/{villa_category}/edit', [
        'as' => 'admin.villamanager.category.edit',
        'uses' => 'CategoryController@edit',
        'middleware' => 'can:villamanager.categories.edit'
    ]);

    $router->put('categories/{villa_category}', [
        'as' => 'admin.villamanager.category.update',
        'uses' => 'CategoryController@update',
        'middleware' => 'can:villamanager.categories.edit'
    ]);

    $router->delete('categories/{villa_category}', [
        'as' => 'admin.villamanager.category.destroy',
        'uses' => 'CategoryController@destroy',
        'middleware' => 'can:villamanager.categories.destroy'
    ]);

    $router->get('reports', [
        'as' => 'admin.villamanager.report.index',
        'uses' => 'ReportController@index',
        'middleware' => 'can:villamanager.reports.index'
    ]);
