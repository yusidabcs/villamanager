...
class VillamanagerServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishConfig('villamanager', 'config');
        $this->publishConfig('villamanager', 'permissions');
        $this->publishConfig('villamanager', 'settings');
    ...
    private function registerBindings()
    {
        ...
        $this->app->bind(
            ...
            function () {
                ...
                return new \Modules\Villamanager\Repositories\Cache\CacheAreaDecorator($repository);
            }
        );
