<div class="box-body">
    <div class="box-body">
        ...
        <div class='{{ $errors->has("{$lang}.short_description") ? ' has-error' : '' }}'>
            ...
            <textarea class="form-control" name="{{$lang}}[short_description]" >{{ old("{$lang}.short_description") }}</textarea>
        ...
        <div class='{{ $errors->has("{$lang}.tos") ? ' has-error' : '' }}'>
            ...
            <textarea class="ckeditor" name="{{$lang}}[tos]" >{{ old("{$lang}.tos") }}</textarea>
            ...
            <div style="height: 0px;" id="collapseTwo-{{$lang}}" class="panel-collapse collapse">
                <div class="box-body">
                    <div class='form-group{{ $errors->has("{$lang}[meta_title]") ? ' has-error' : '' }}'>
                        ...
                        {!! Form::text("{$lang}[meta_title]", old("$lang.meta_title"), ['class' => "form-control", 'placeholder' => trans('villamanager::villas.form.meta_title')]) !!}
