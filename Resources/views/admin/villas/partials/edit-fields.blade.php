<div class="box-body">
    <div class="box-body">
        ...
        <div class='{{ $errors->has("{$lang}.short_description") ? ' has-error' : '' }}'>
            ...
            <textarea class="form-control" name="{{$lang}}[short_description]" id="{{$lang}}_short_description" >{{ old("{$lang}.short_description",$villa->translate($lang) ? $villa->translate($lang)->short_description : '') }}</textarea>
        ...
        <div class='{{ $errors->has("{$lang}.description") ? ' has-error' : '' }}'>
            ...
            <textarea class="ckeditor" name="{{$lang}}[description]" id="{{$lang}}_description">{{ old("{$lang}.description", $villa->translate($lang) ? $villa->translate($lang)->description : '') }}</textarea>
        ...
        <div class='{{ $errors->has("{$lang}.tos") ? ' has-error' : '' }}'>
            ...
            <textarea class="ckeditor" name="{{$lang}}[tos]" id="{{$lang}}_tos" >{{ old("{$lang}.tos", $villa->translate($lang) ? $villa->translate($lang)->tos : '') }}</textarea>
            ...
            <div style="height: 0px;" id="collapseTwo-{{$lang}}" class="panel-collapse collapse">
                <div class="box-body">
                    <div class='form-group{{ $errors->has("{$lang}[meta_title]") ? ' has-error' : '' }}'>
                        ...
                        {!! Form::text("{$lang}[meta_title]", old("$lang.meta_title", $villa->hasTranslation($lang) ? $villa->translate($lang)->meta_title : ''), ['class' => "form-control", 'placeholder' => trans('villamanager::villas.form.meta_title')]) !!}
                    ...
                    <div class='form-group{{ $errors->has("{$lang}[meta_keyword]") ? ' has-error' : '' }}'>
                        ...
                        {!! Form::text("{$lang}[meta_keyword]", old("$lang.meta_keyword", $villa->hasTranslation($lang) ? $villa->translate($lang)->meta_keyword : ''), ['class' => "form-control", 'placeholder' => trans('villamanager::villas.form.meta_keyword')]) !!}
                    ...
                    <div class='form-group{{ $errors->has("{$lang}[meta_description]") ? ' has-error' : '' }}'>
                        ...
                        <textarea class="form-control" name="{{$lang}}[meta_description]" rows="10" cols="80">{{ old("$lang.meta_description", $villa->hasTranslation($lang) ? $villa->translate($lang)->meta_description : '') }}</textarea>
