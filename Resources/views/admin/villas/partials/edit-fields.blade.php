<div class="box-body">
    <div class="box-body">
        ...
        <div class='{{ $errors->has("{$lang}.short_description") ? ' has-error' : '' }}'>
            ...
            <textarea class="form-control" name="{{$lang}}[short_description]" >{{ old("{$lang}.short_description",$villa->translate($lang) ? $villa->translate($lang)->short_description : '') }}</textarea>
        ...
        <div class='{{ $errors->has("{$lang}.description") ? ' has-error' : '' }}'>
            ...
            <textarea class="ckeditor" name="{{$lang}}[description]" >{{ old("{$lang}.description", $villa->translate($lang) ? $villa->translate($lang)->description : '') }}</textarea>
        ...
        <div class='{{ $errors->has("{$lang}.tos") ? ' has-error' : '' }}'>
            ...
            <textarea class="ckeditor" name="{{$lang}}[tos]" >{{ old("{$lang}.tos", $villa->translate($lang) ? $villa->translate($lang)->tos : '') }}</textarea>
