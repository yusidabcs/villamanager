...
<div class="row">
    <div class="col-md-12">
        <div class='form-group{{ $errors->has('name') ? ' has-error' : '' }} '>
            ...
            {!! Form::text('name', old('name',$villa->name.' copy'), ['class' => 'form-control', 'placeholder' => trans('villamanager::villas.form.name')]) !!}
...
<div class="row">
    <div class='form-group{{ $errors->has('slug') ? ' has-error' : '' }} col-md-12'>
        ...
        {!! Form::text('slug', old('slug',$villa->slug.'-copy'), ['class' => 'form-control', 'placeholder' => trans('villamanager::villas.form.slug'),'required']) !!}
