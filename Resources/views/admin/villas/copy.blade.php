...
@section('content-header')
    <h1>
        {{ trans('villamanager::villas.title.copy villa') }} : {{ $villa->name }}
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="alert alert-warning">
                    This is duplicate villa, please remember to update the title, slug url and other things so you will not have duplicate content!
                    <input type="hidden" name="copy" value="true">
                </div>
                <div class="box-body">
                    @include('villamanager::admin.villas.partials.copy-nontrans-fields')
                </div>
            </div>
