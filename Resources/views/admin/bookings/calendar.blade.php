...
<h1>
  {{ trans('villamanager::bookings.title.bookings') }}

    @if(!request()->has('view'))
    <a href="{{ route('admin.villamanager.booking.index') }}"><i class="fa fa-list"></i></a>
    @endif
</h1>
<ol class="breadcrumb">
  <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
    ...
    @if(request()->has('villa'))
        <li><a href="{{ route('admin.villamanager.villa.edit',request('villa')) }}">Detail Villa</a></li>
    @endif
      ...
      <div class="box-body table-responsive">
          ...
          <div class="col-md-12 text-center">
            <div class="form-group">
              ...
              <div class="form-group pull-right">
                  <a href="{{ route('admin.villamanager.villa.edit', [$villa->id]) }}" class="btn btn-success"> < Back to Villa</a>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div id='calendar' data-delete="{{ route('admin.villamanager.rate.index') }}" data-url="{{ route('api.villamanger.unavailabledate').'?view=calendar'.(request()->has('villa') ? '&villa='.request()->get('villa') : '') }}" data-disable="{{ route('admin.villamanager.disabledate.index') }}"
            data-export="{{ route('villamanager.booking.export-ics',request()->get('villa')) }}"
            ></div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select name="country_id" class="form-control"  required="" style="width:100%">
                  <option value="">
                      -- Select country --
                  </option>
...
<div class="modal fade" id="import-booking" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Import Booking</h4>
            </div>

            {!! Form::open(['url' => route('api.villamanager.booking.import',request('villa')) , 'method' => 'post','id' => 'import-booking-form', 'class' => 'form']) !!}
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="villa_id">Ics Link</label>
                            <input type="text" class="form-control" id="ics_file" name="ics_file" placeholder="Icl file link" required="" >
                        </div>
