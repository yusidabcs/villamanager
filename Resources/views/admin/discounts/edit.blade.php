...
@section('content')
    {!! Form::open(['route' => ['admin.villamanager.discount.update',$discount->id], 'method' => 'put']) !!}
    <div class="row">
                        ...
                        <div class="box-body">
                            <div class='form-group{{ $errors->has('icon') ? ' has-error' : '' }}'>
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="text" class="form-control" name="code" id="discount_code" value="{{ old('code') ? old('code'): $discount->code }}" >
                            ...
                            <div class='form-group{{ $errors->has('type') ? ' has-error' : '' }}'>
                                ...
                                <select class="form-control" required="" name="type" id="type">
                                    <option value="1" {{ old('type') ? (old('type') == '1' ? 'selected' : '') : $discount->id == 1 ? 'selected' : '' }}>Nominal</option>
                                    <option value="2" {{ old('type') ? (old('type') == 2 ? 'selected' : '') : $discount->id == 2 ? 'selected' : '' }}>Percent</option>
                                </select>
                            ...
                            <div class='form-group{{ $errors->has('discount') ? ' has-error' : '' }}' >
                                ...
                                <div class="input-group">
                                    <div class="input-group-btn" id="nominal" {!! old('type') ? old('type') == 2   ? 'style="display: none"': '' : $discount->type == 2 ? 'style="display: none"': '' !!} >
                                        <button type="button" class="btn btn-danger">{{ setting('core::currency')  }}</button>
                                    </div>
                                    <!-- /btn-group -->
                                    <input type="text" class="form-control" name="discount" value="{{ old('discount') ? old('discount') : $discount->discount }}">

                                    <div class="input-group-btn" id="percent" {!! old('type') == 1 || $discount->type == 1 ? 'style="display: none"': '' !!} >
                            ...
                            <div class='form-group{{ $errors->has('minimumPayment') ? ' has-error' : '' }}'>
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- /btn-group -->
                                    <input type="text" class="form-control" name="minimumPayment" value="{{ old('minimumPayment') ? old('minimumPayment') : $discount->minimumPayment }}">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group date" id="start_date"  data-date-format="yyyy-mm-dd"
                                        ...
                                        <input type="text" class="form-control" name="start_date" readonly="" value="{{ old('start_date') ? old('start_date') : $discount->start_date  }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group date" id="end_date"  data-date-format="yyyy-mm-dd"
                                         data-date-autoclose="true" >
                                        <input type="text" class="form-control" name="end_date" readonly="" value="{{ old('end_date') ? old('end_date') : $discount->end_date }}">
                                        <div class="input-group-addon">
                                            <span class="glyphicon glyphicon-th"></span>
                                        </div>
                                    </div>
                            ...
                            <div class='form-group'>
                                ...
                                <input type="text" class="form-control" name="total" required="" value="{{ old('total') ? old('total') : $discount->total  }}">
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat">{{ trans('core::core.button.update') }}</button>
                        <a class="btn btn-danger pull-right btn-flat" href="{{ route('admin.villamanager.discount.index')}}"><i class="fa fa-times"></i> {{ trans('core::core.button.cancel') }}</a>
                    </div>
                </div>
